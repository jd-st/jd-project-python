...
```python
from jd_project.types import St00000reListInventoryResponse
```

Methods:

- <code title="get /st00000re/inventory">client.st00000re.<a href="./src/jd_project/resources/st00000re/st00000re.py">list_inventory</a>() -> <a href="./src/jd_project/types/st00000re_list_inventory_response.py">St00000reListInventoryResponse</a></code>

## Orders

Methods:

- <code title="post /st00000re/order">client.st00000re.orders.<a href="./src/jd_project/resources/st00000re/orders.py">create</a>(\*\*<a href="src/jd_project/types/st00000re/order_create_params.py">params</a>) -> <a href="./src/jd_project/types/shared/order.py">Order</a></code>
- <code title="get /st00000re/order/{orderId}">client.st00000re.orders.<a href="./src/jd_project/resources/st00000re/orders.py">retrieve</a>(order_id) -> <a href="./src/jd_project/types/shared/order.py">Order</a></code>
- <code title="delete /st00000re/order/{orderId}">client.st00000re.orders.<a href="./src/jd_project/resources/st00000re/orders.py">delete</a>(order_id) -> None</code>
